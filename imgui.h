...
#define IMGUIEX_VERSION       "1.91.5EX"
...
namespace ImGui
{
    ...
    IMGUI_API bool          TimelineArrowToButton(const char* str_id, ImGuiDir dir);          // ExtremeEngine timeline
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_PickerHueCircle = 1 << 27,  // [Picker]     // ColorPicker: wheel for Hue, circle for Sat/Value.
